...
<div id="page-container" class="row">
	...
	<div id="page-content" class="col-sm-9">
		...
		<div class="Programs index">
			...
			<h2><?php echo __('Program: '); ?><?php echo h($program['Program']['name']); ?></h2>
			<ol class="breadcrumb">
			...
			<?php 	if ( $this->Session->Read('Auth.User.role_id') == 1) {
					...
					echo '<li>' . $this->Html->link(' List of Program ', array('controller' => 'programs', 'action' => 'admin_index')).'</li>';
					echo '<li>' . $this->Html->link(' Add new Program ', array('controller' => 'programs', 'action' => 'admin_add')).'</li>';
					}
			...
			<?php if (!empty($program['Profile'])): ?>
				<table cellpadding="0" cellspacing="0" class="table table-striped table-bordered">
					...
					<tbody>
<?php foreach ($program['Profile'] as $profile): ?>
	<tr>
