...
<ol class="breadcrumb">
					...
					if ( $this->Session->Read('Auth.User.role_id') == 1) {
             		...
             		if ( $this->Session->Read('Auth.User.role_id') == 3) {
             		 ...
             		 ?></li>
					<li class="active"> <?php echo "View Courseware Video";?></li>
...
<ul class="nav nav-tabs" id="myTab">
  ...
  <li class="active"><a href="#courseware" data-toggle="tab">Courseware</a></li>
...
<div class="tab-content">
  <div class="tab-pane active" id="courseware">
  <br/>
<div class="panel panel-default">
  <div class="panel-body">

<div class="row">
  <div class="col-xs-12 col-sm-6 col-md-8"><?php if ($video['Video']['status'] == "accept") {
			echo '<h5 class="text-success list-group-item-text"> Courseware :<b>' .' ' .h($video['Video']['status']).'</b></h5>' ;
		}

		if ($video['Video']['status'] == "pending") {
			echo '<h5 class="text-warning list-group-item-text"> Courseware :<b>' .' '.h($video['Video']['status']).'</b></h5>' ;
		}

		if ($video['Video']['status'] == "reject") {
			echo '<h5 class="text-danger list-group-item-text"> Courseware :<b>' .' '.h($video['Video']['status']).'</b></h5>' ;
		}
				
		?>
			<br/>
			<p><?php echo h($video['Video']['comware']); ?></p>
...
<script>
  $(function () {
	...
	<p><?php echo $this->Coursewares->display_for($video); ?></p>
