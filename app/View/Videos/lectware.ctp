...
<div id="page-container" class="row">
	...
	<div id="page-content" class="col-sm-9">
		...
		<div class="Video index">
			...
			<h2><?php echo __('Video - <b>Lecture Courseware</b>'); ?></h2>
			<ol class="breadcrumb">
...
<?php foreach ($videos as $video): ?>
	...
	<div class="list-group">
		...
		<br/>
			<p>
			<?php echo $this->Html->link(__('Validate'), array('action' => 'val2ware', $video['Video']['id']),array('class'=>'btn btn-info btn-xs')); ?></p>
		</div>
