...
<div id="page-container" class="row">
	...
	<div id="page-content" class="col-sm-9">
		...
		<div class="Video index">
			...
			<h2><?php echo __('Video - <b>Public</b>'); ?></h2>
			<ol class="breadcrumb">
					...
					if ( $this->Session->Read('Auth.User.role_id') == 1) {
             		...
             		if ( $this->Session->Read('Auth.User.role_id') == 3) {
             		 ...
             		 ?></li>
					<li class="active"> <?php echo "List of Public Video";?></li>
...
<?php foreach ($videos as $video): ?>
	...
	<div class="list-group">
		...
		<h6 class="text-info list-group-item-text"> Visibility:<b>
			...
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $video['Video']['id']), array('class'=>'btn btn-danger btn-xs'), __('Are you sure you want to delete # %s?', $video['Video']['id'])); ?>
		</div>
