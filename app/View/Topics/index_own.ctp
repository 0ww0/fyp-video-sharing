...
<?php foreach ($topics as $topic): ?>
	<tr>
      ...
      foreach($topic['Course'] as $course){ 
		...
		<td><?php echo $this->Html->link(__('Edit'), array('action' => 'edit', $topic['Topic']['id']),array('class'=>'btn btn-info btn-xs')); ?>
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $topic['Topic']['id']),array('class'=>'btn btn-danger btn-xs'), null, __('Are you sure you want to delete # %s?', $topic['Topic']['id'])); ?></td>
