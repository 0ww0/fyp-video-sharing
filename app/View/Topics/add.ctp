	...
	<div id="page-content" class="col-sm-9">
		...
		<div class="Topic form">
			...
			<?php echo $this->Form->create('Topic', array('type'=>'file','inputDefaults' => array('label' => false), 'role' => 'form')); ?>
				<fieldset>
					<h2><?php echo __('Add Forum'); ?></h2>
						<ol class="breadcrumb">
              
             		 <li><i class="glyphicon glyphicon-user">&nbsp;</i> <?php 	if ( $this->Session->Read('Auth.User.role_id') == 1) {
					...
					echo '<li>' . $this->Html->link(' Dashboard ', array('controller' => 'lecturers', 'action' => 'index')).'</li>';
             		 ...
             		 <li class ="active"> <?php echo "Add new Forum Topic";?></li>
